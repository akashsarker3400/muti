...
export const seedPages = [
  ...
  },
  {
    ...
    bodyBn:
      "<p>এই ওয়েবসাইটে আপনি যে তথ্য দেন (নাম, মোবাইল নম্বর, ইমেইল, শিক্ষাগত যোগ্যতা ও মেসেজ) তা শুধুমাত্র আপনার ভর্তি বা অনুসন্ধানের বিষয়ে আপনার সাথে যোগাযোগ করার জন্য ব্যবহার করা হয়।</p><h2>আমরা কী সংগ্রহ করি</h2><p>ভর্তি আবেদন, ফ্রি ক্লাস বুকিং ও যোগাযোগ ফরমে দেওয়া তথ্য আমাদের নিজস্ব সার্ভারে সংরক্ষিত থাকে।</p><h2>আমরা কী করি না</h2><p>আপনার তথ্য কোনো তৃতীয় পক্ষের কাছে বিক্রি বা হস্তান্তর করা হয় না।</p><h2>ওয়েবসাইট পরিসংখ্যান</h2><p>ভিজিটর পরিসংখ্যান বুঝতে আমরা Google Analytics ও Meta Pixel ব্যবহার করতে পারি।</p><h2>যোগাযোগ</h2><p>আপনার তথ্য মুছে ফেলার অনুরোধ জানাতে অফিসের ইমেইল বা ফোনে যোগাযোগ করুন।</p>",
    bodyEn:
      "<p>The information you provide on this website (name, mobile number, email, qualification and message) is used only to contact you about your admission or enquiry.</p><h2>What we collect</h2><p>Details submitted through the admission application, free class booking and contact forms are stored on our own server.</p><h2>What we do not do</h2><p>We do not sell or pass your information on to any third party.</p><h2>Website statistics</h2><p>We may use Google Analytics and the Meta Pixel to understand visitor statistics.</p><h2>Contact</h2><p>To request deletion of your information, contact the office by email or phone.</p>",
  },
  {
    slug: "terms",
    titleBn: "শর্তাবলি",

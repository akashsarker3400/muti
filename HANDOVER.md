...
| 2.12 | **Partner logos** (BTEB, Ministry, WAUCM, Jonosastho)       | Admin → অনুমোদন ও সহযোগী → লোগো                                     | Each card shows a solid navy monogram of the organisation's initials — a deliberate mark, not an empty frame. We did not draw stand-in versions of a government emblem or another organisation's trademark; upload the official artwork only if MUTI is licensed to use it. |

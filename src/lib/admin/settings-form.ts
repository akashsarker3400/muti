      ...
      { name: "homepage.announcementActive", label: "ঘোষণা চালু", type: "checkbox" },
      {
        ...
        options: [
          { value: "", label: "— নিজের লেখা রাখুন —" },
          {
            value: "HEALTH",
            label:
              "গর্ভবতী মায়েদের জন্য বিনামূল্যে আল্ট্রাসোনোগ্রাম ও ডাক্তার পরামর্শ, সিরিয়াল: …",
          },
        ],
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "এ পর্যন্ত চিকিৎসকের পরামর্শ (ভিত্তি সংখ্যা)",
        type: "number",
      },
      { name: "health.heroImage", label: "পাতার ছবি", type: "image" },
      {
        name: "health.ogImage",
        label: "সোশ্যাল শেয়ার কার্ড (১২০০×৬৩০, ঐচ্ছিক)",
        type: "image",
        hint: "Facebook/WhatsApp-এ লিংক শেয়ার হলে এই ছবি দেখাবে। না দিলে ইংরেজি ট্যাগলাইনের একটি কার্ড নিজে থেকে তৈরি হয় (বাংলা লেখা স্বয়ংক্রিয়ভাবে রেন্ডার করা যায় না)।",
      },
      {
        name: "health.commitmentLabelBn",
        label: "সেকশন লেবেল (বাংলা)",
        type: "text",
        lang: "bn",
      },
      {
        name: "health.taglineBn",
        label: "ট্যাগলাইন, উদ্ধৃতি (বাংলা)",
        type: "textarea",
        lang: "bn",
        full: true,
      },
